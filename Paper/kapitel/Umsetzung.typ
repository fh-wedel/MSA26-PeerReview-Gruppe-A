...
Das Open-Source-Projekt OpenCode soll eine Alternative zu den proprietären Agentensystemen darstellen. Es bietet die Möglichkeit, beliebige @LLM:pl von verschiedensten Anbietern zu integrieren oder die Agenten auf selbstgehosteten Instanzen zu betreiben. OpenCode ist hochgradig konfigurierbar und erlaubt die Erweiterung durch Plugins. So ist es beispielsweise möglich, dass KI-Agenten, die auf verschiedenen Plattformen ausgeführt werden, miteinander kommunizieren und von einem einzigen kombinierten System orchestriert werden. Ein Austausch von verwendeten @LLM:pl oder Anbietern gestaltet sich durch die offene Architektur denkbar einfach und kann üblicherweise ohne Modifikationen der Agenten oder sonstigen Konfigurationen erfolgen.  
