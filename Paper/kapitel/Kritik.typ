...
- Auch ohne jedliche Erfahrung mit @AWS oder Spring konnte ich Features umsetzen.
- Meine Einordnung: Für einen PoC ist dies möglicherweise sinnvoll. Für komplexe Software, die umgesetzt werden muss, jedoch nicht.
...
- Der Agent macht zum teil sehr sehr viel nur halb. Mal vergisst er die Test anzupassen, mal lässt sich das projekt gar nicht compilieren, weil das Imports fehlen etc. Selbst beim Propmt: Fixe comiler fehler und tests, hat er zwar änderungen gemacht aber es hat nicht funktioniert neue/andere fehler
