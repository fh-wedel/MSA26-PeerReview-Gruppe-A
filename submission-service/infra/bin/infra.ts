...
const serviceStack = new ServiceStack(app, 'SubmissionServiceStack', {
  ...
  description: ' This stack manages the submission configuration and files.',
  enablePublicIpV4: false,
  containerPort: containerPort,
  requestQueueName: 'submission-request-queue',
  responseQueueName: 'submission-response-queue',
  minTaskCount: 1,
  maxTaskCount: 2,
  memory: 512,
  cpu: 256,
