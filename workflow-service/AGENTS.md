...
- **API Gateway Permissions:** Any new endpoint must be explicitly added to `infra/verified-permissions/workflow-policies.json` for all relevant roles (Admin, Author, Teacher, Reviewer, ExaminationOfficer).
