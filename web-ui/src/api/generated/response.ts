...
export class HttpClient<SecurityDataType = unknown> {
  public baseUrl: string = "/api/response";
...
> extends HttpClient<SecurityDataType> {
  results = {
     ...
     *
     * @name ResultsCreate
     * @summary Submit a review result for a submission
     * @request POST:/results
     */
    resultsCreate: (data: SubmitReviewRequest, params: RequestParams = {}) =>
     ...
     * @request GET:/results/{submissionId}/document
     */
    documentList: (submissionId: string, params: RequestParams = {}) =>
      this.request<
        {
          downloadUrl?: string;
        },
        any
      >({
        path: `/results/${submissionId}/document`,
        method: "GET",
        format: "json",
        ...params,
      }),
