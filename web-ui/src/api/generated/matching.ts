...
export interface ExaminerResponse {
   ...
   */
  email: string;
  /** Whether the Cognito user is enabled or disabled */
  enabled?: boolean;
  /**
   * Cognito user status (e.g., CONFIRMED, FORCE_CHANGE_PASSWORD)
   * @example "CONFIRMED"
   */
  status?: string;
  /** @format date-time */
  createdAt?: string;
  /** Custom Cognito attributes (e.g., specialty, availability) */
...
export interface CreateExaminerRequest {
  /**
   * The Cognito username (e.g. 'Marcel') of an existing user to promote to reviewer. Not the sub UUID.
   * @example "Marcel"
   */
  username: string;
  customAttributes?: Record<string, string>;
...
export interface UpdateExaminerRequest {
  /** Custom attributes to update on the Cognito user */
  customAttributes?: Record<string, string>;
}
...
> extends HttpClient<SecurityDataType> {
  ...
  examiners = {
     ...
     * @tags examiners
     * @name ListExaminers
     * @summary Lists all available reviewers from the Cognito Reviewer group
     * @request GET:/examiners
     */
    listExaminers: (params: RequestParams = {}) =>
      this.request<ExaminerResponse[], CognitoErrorResponse>({
        path: `/examiners`,
        method: "GET",
        format: "json",
        ...params,
     ...
     * @tags examiners
     * @name CreateExaminer
     * @summary Creates a new reviewer in the Cognito Reviewer group
     * @request POST:/examiners
     */
    createExaminer: (data: CreateExaminerRequest, params: RequestParams = {}) =>
      this.request<ExaminerResponse, ErrorResponse | CognitoErrorResponse>({
        path: `/examiners`,
        method: "POST",
        body: data,
     ...
     * @tags examiners
     * @name GetExaminer
     * @summary Returns details of a specific reviewer from Cognito
     * @request GET:/examiners/{examinerUsername}
     */
    getExaminer: (examinerUsername: string, params: RequestParams = {}) =>
      this.request<ExaminerResponse, CognitoErrorResponse | ErrorResponse>({
        path: `/examiners/${examinerUsername}`,
        method: "GET",
        format: "json",
        ...params,
      }),
     ...
     * @tags examiners
     * @name UpdateExaminer
     * @summary Updates the metadata/custom attributes of a reviewer in Cognito
     * @request PATCH:/examiners/{examinerUsername}
     */
    updateExaminer: (
      examinerUsername: string,
      data: UpdateExaminerRequest,
      params: RequestParams = {},
    ) =>
      this.request<ExaminerResponse, ErrorResponse | CognitoErrorResponse>({
        path: `/examiners/${examinerUsername}`,
     ...
     * @tags examiners
     * @name DeleteExaminer
     * @summary Deletes a reviewer from the Cognito User Pool
     * @request DELETE:/examiners/{examinerUsername}
     */
    deleteExaminer: (examinerUsername: string, params: RequestParams = {}) =>
      this.request<void, CognitoErrorResponse | ErrorResponse>({
        path: `/examiners/${examinerUsername}`,
        method: "DELETE",
        ...params,
      }),
